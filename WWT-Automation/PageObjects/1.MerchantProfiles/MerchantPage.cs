...
namespace WWT_Automation.PageObjects._1.MerchantProfiles
{
    public class MerchantPage : BasePage
    {
        ...
        private readonly By _merchantStatusDropdown = By.CssSelector("md-select[ng-model='form.ComplianceOfficerId']");
        private readonly By _availableMerchantStatuses = By.CssSelector("md-select-menu[role='presentation'][class='_md']");
